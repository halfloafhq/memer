...
const ForgotPasswordForm = () => {
  ...
  return (
    <div>
      {steps === 1 && <EmailStep onSubmit={handleEmailSubmit} loading={loading} />}
      {steps === 2 && <PasswordStep onSubmit={handlePasswordSubmit} loading={loading} />}
      {steps === 3 && <CodeStep onSubmit={handleCodeSubmit} loading={loading} />}
    </div>
  );
};
